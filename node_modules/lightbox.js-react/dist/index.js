...
var SlideshowLightbox = React.forwardRef(function (props, ref) {
  ...
  var _useState8 = React.useState(initialThumbnailOptions),
  ...
  var _useState11 = React.useState(false),
    setIsDisplay = _useState11[1];
  var _useState12 = React.useState(false),
    isOpen = _useState12[0],
    setIsOpen = _useState12[1];
  var _useState13 = React.useState(null),
    prevFocusedElem = _useState13[0],
    setPrevFocusedElem = _useState13[1];
  var _useState14 = React.useState(false),
    animationEntered = _useState14[0],
    setAnimationEntered = _useState14[1];
  var _useState15 = React.useState(props.magnifyingGlass ? props.magnifyingGlass : false),
    magnifyingGlassFeature = _useState15[0];
  var _useState16 = React.useState(props.disableImageZoom ? props.disableImageZoom : false),
    disableZoom = _useState16[0],
    setDisableZoom = _useState16[1];
  var _useState17 = React.useState(props.slideshowInterval ? props.slideshowInterval : 1700),
    slideshowInterval = _useState17[0];
  var _useState18 = React.useState(props.rightArrowStyle ? props.rightArrowStyle : {}),
    rightArrowStyle = _useState18[0];
  var _useState19 = React.useState(props.leftArrowStyle ? props.leftArrowStyle : {}),
    leftArrowStyle = _useState19[0];
  var _useState20 = React.useState(props.roundedImages ? props.roundedImages : false),
    isRounded = _useState20[0],
    setIsRounded = _useState20[1];
  var _useState21 = React.useState(props.showControls ? props.showControls : true),
    showControls = _useState21[0],
    setShowControls = _useState21[1];
  var _useState22 = React.useState(props.showFullScreenIcon ? props.showFullScreenIcon : true),
    displayFullScreenIcon = _useState22[0],
    setDisplayFullScreenIcon = _useState22[1];
  var _useState23 = React.useState(props.showThumbnailIcon ? props.showThumbnailIcon : true),
    displayThumbnailIcon = _useState23[0],
    setDisplayThumbnailIcon = _useState23[1];
  var _useState24 = React.useState(props.showSlideshowIcon ? props.showSlideshowIcon : true),
    setDisplaySlideshowIcon = _useState24[1];
  var _useState25 = React.useState(props.showMagnificationIcons ? props.showMagnificationIcons : true),
    displayMagnificationIcons = _useState25[0],
    setDisplayMagnificationIcons = _useState25[1];
  var _useState26 = React.useState(props.nextArrow ? props.nextArrow : null),
    nextArrowElem = _useState26[0];
  var _useState27 = React.useState(props.imageComponent ? props.imageComponent : null),
    isImageComponent = _useState27[0];
  var _useState28 = React.useState(props.prevArrow ? props.prevArrow : null),
    prevArrowElem = _useState28[0];
  var _useState29 = React.useState(props.modalClose ? props.modalClose : "default"),
    modalCloseOption = _useState29[0];
  var _useState30 = React.useState(props.downloadImages ? props.downloadImages : false),
    showDownloadBtn = _useState30[0];
  var _useState31 = React.useState(props.rtl ? props.rtl : false),
    isRTL = _useState31[0];
  var _useState32 = React.useState(props.framework ? props.framework : ''),
    frameworkID = _useState32[0];
  var _useState33 = React.useState(props.lightboxIdentifier ? props.lightboxIdentifier : false),
    lightboxIdentifier = _useState33[0];
  var _useState34 = React.useState(props.fullScreen ? props.fullScreen : false),
    imageFullScreen = _useState34[0];
  var _useState35 = React.useState(props.licenseKey ? props.licenseKey : '');
  var _useState36 = React.useState(props.showLoader ? props.showLoader : false),
    displayLoader = _useState36[0],
    setDisplayLoader = _useState36[1];
  var _useState37 = React.useState(props.startingSlideIndex ? props.startingSlideIndex : 0),
    setStartingIndex = _useState37[1];
  var _useState38 = React.useState(props.backgroundColor ? props.backgroundColor : themes[defaultTheme].background),
    backgroundColor = _useState38[0],
    setBackgroundColor = _useState38[1];
  var _useState39 = React.useState(props.iconColor ? props.iconColor : null),
    iconColor = _useState39[0],
    setIconColor = _useState39[1];
  var _useState40 = React.useState(props.textColor ? props.textColor : themes[defaultTheme].textColor),
    textColor = _useState40[0],
    setTextColor = _useState40[1];
  var _useState41 = React.useState(props.useCoverMode ? props.useCoverMode : false),
    coverMode = _useState41[0];
  var _useState42 = React.useState(props.displayMetadata ? props.displayMetadata : false),
    displayImgMetadata = _useState42[0];
  var _useState43 = React.useState(props.showThumbnails ? props.showThumbnails : false),
    showThumbnails = _useState43[0],
    setShowThumbnails = _useState43[1];
  var _useState44 = React.useState(props.animateThumbnails ? props.animateThumbnails : true),
    animatedThumbnails = _useState44[0];
  var _useState45 = React.useState(props.imgAnimation ? props.imgAnimation : 'imgDrag'),
    setImgAnimation = _useState45[1];
  var _useState46 = React.useState(props.arrowStyle ? props.arrowStyle : 'dark'),
    arrowStyle = _useState46[0];
  var _useState47 = React.useState(false),
    setYTVideoCurrentlyPlaying = _useState47[1];
  var _useState48 = React.useState(0),
    width = _useState48[0],
    setWidth = _useState48[1];
  var _useState49 = React.useState(false),
    isBrowserFullScreen = _useState49[0],
    setIsBrowserFullScreen = _useState49[1];
  var _useState50 = React.useState(false),
    enableMagnifyingGlass = _useState50[0],
    setMagnifyingGlass = _useState50[1];
  var _useState51 = React.useState(false),
    imagesLoaded = _useState51[0],
    setImagesLoaded = _useState51[1];
  var imageRef = React.useRef(null);
  var _useState52 = React.useState(0),
    zoomIdx = _useState52[0],
    setZoomIdx = _useState52[1];
  var _useState53 = React.useState(500),
    imgContainHeight = _useState53[0],
    setImgContainHeight = _useState53[1];
  var _useState54 = React.useState(426),
    imgContainWidth = _useState54[0],
    setImgContainWidth = _useState54[1];
  var _useState55 = React.useState(false),
    isInit = _useState55[0],
    setIsInit = _useState55[1];
  var open = props.open;
  ...
  var _useState56 = React.useState({}),
    videoElements = _useState56[0],
    setVideoElements = _useState56[1];
  ...
  var _useState57 = React.useState(props.thumbnailBorder ? createCustomThumbnailBorder() : themes[defaultTheme].thumbnailBorder),
    thumbnailBorder = _useState57[0];
