...
var SlideshowLightbox = forwardRef(function (props, ref) {
  ...
  var _useState15 = useState(props.magnifyingGlass ? props.magnifyingGlass : false),
    magnifyingGlassFeature = _useState15[0];
  var _useState16 = useState(props.disableImageZoom ? props.disableImageZoom : false),
    disableZoom = _useState16[0],
    setDisableZoom = _useState16[1];
  var _useState17 = useState(props.slideshowInterval ? props.slideshowInterval : 1700),
    slideshowInterval = _useState17[0];
  var _useState18 = useState(props.rightArrowStyle ? props.rightArrowStyle : {}),
    rightArrowStyle = _useState18[0];
  var _useState19 = useState(props.leftArrowStyle ? props.leftArrowStyle : {}),
    leftArrowStyle = _useState19[0];
  var _useState20 = useState(props.roundedImages ? props.roundedImages : false),
    isRounded = _useState20[0],
    setIsRounded = _useState20[1];
  var _useState21 = useState(props.showControls ? props.showControls : true),
    showControls = _useState21[0],
    setShowControls = _useState21[1];
  var _useState22 = useState(props.showFullScreenIcon ? props.showFullScreenIcon : true),
    displayFullScreenIcon = _useState22[0],
    setDisplayFullScreenIcon = _useState22[1];
  var _useState23 = useState(props.showThumbnailIcon ? props.showThumbnailIcon : true),
    displayThumbnailIcon = _useState23[0],
    setDisplayThumbnailIcon = _useState23[1];
  var _useState24 = useState(props.showSlideshowIcon ? props.showSlideshowIcon : true),
    setDisplaySlideshowIcon = _useState24[1];
  var _useState25 = useState(props.showMagnificationIcons ? props.showMagnificationIcons : true),
    displayMagnificationIcons = _useState25[0],
    setDisplayMagnificationIcons = _useState25[1];
  var _useState26 = useState(props.nextArrow ? props.nextArrow : null),
    nextArrowElem = _useState26[0];
  var _useState27 = useState(props.imageComponent ? props.imageComponent : null),
    isImageComponent = _useState27[0];
  var _useState28 = useState(props.prevArrow ? props.prevArrow : null),
    prevArrowElem = _useState28[0];
  var _useState29 = useState(props.modalClose ? props.modalClose : "default"),
    modalCloseOption = _useState29[0];
  var _useState30 = useState(props.downloadImages ? props.downloadImages : false),
    showDownloadBtn = _useState30[0];
  var _useState31 = useState(props.rtl ? props.rtl : false),
    isRTL = _useState31[0];
  var _useState32 = useState(props.framework ? props.framework : ''),
    frameworkID = _useState32[0];
  var _useState33 = useState(props.lightboxIdentifier ? props.lightboxIdentifier : false),
    lightboxIdentifier = _useState33[0];
  var _useState34 = useState(props.fullScreen ? props.fullScreen : false),
    imageFullScreen = _useState34[0];
  var _useState35 = useState(props.licenseKey ? props.licenseKey : '');
  var _useState36 = useState(props.showLoader ? props.showLoader : false),
    displayLoader = _useState36[0],
    setDisplayLoader = _useState36[1];
  var _useState37 = useState(props.startingSlideIndex ? props.startingSlideIndex : 0),
    setStartingIndex = _useState37[1];
  var _useState38 = useState(props.backgroundColor ? props.backgroundColor : themes[defaultTheme].background),
    backgroundColor = _useState38[0],
    setBackgroundColor = _useState38[1];
  var _useState39 = useState(props.iconColor ? props.iconColor : null),
    iconColor = _useState39[0],
    setIconColor = _useState39[1];
  var _useState40 = useState(props.textColor ? props.textColor : themes[defaultTheme].textColor),
    textColor = _useState40[0],
    setTextColor = _useState40[1];
  var _useState41 = useState(props.useCoverMode ? props.useCoverMode : false),
    coverMode = _useState41[0];
  var _useState42 = useState(props.displayMetadata ? props.displayMetadata : false),
    displayImgMetadata = _useState42[0];
  var _useState43 = useState(props.showThumbnails ? props.showThumbnails : false),
    showThumbnails = _useState43[0],
    setShowThumbnails = _useState43[1];
  var _useState44 = useState(props.animateThumbnails ? props.animateThumbnails : true),
    animatedThumbnails = _useState44[0];
  var _useState45 = useState(props.imgAnimation ? props.imgAnimation : 'imgDrag'),
    setImgAnimation = _useState45[1];
  var _useState46 = useState(props.arrowStyle ? props.arrowStyle : 'dark'),
    arrowStyle = _useState46[0];
  var _useState47 = useState(false),
    setYTVideoCurrentlyPlaying = _useState47[1];
  var _useState48 = useState(0),
    width = _useState48[0],
  ...
  var _useState57 = useState(props.thumbnailBorder ? createCustomThumbnailBorder() : themes[defaultTheme].thumbnailBorder),
